...
const CityManager = () => {
    ...
    useEffect(() => {
        const fetchCities = async () => {
            try {
                const response = await axios.get('https://cancemi-inmobiliaria-backend-admin.vercel.app/api/cities');
    ...
    const handleAddCity = async () => {
        ...
        try {
            const response = await axios.post('https://cancemi-inmobiliaria-backend-admin.vercel.app/api/cities', { name: newCity });
    ...
    const handleDeleteCity = async (id) => {
        try {
            await axios.delete(`https://cancemi-inmobiliaria-backend-admin.vercel.app/api/cities/${id}`);
