...
//             } else {
//                 setModalMessage('No se pudo conectar con el servidor. Verifique su conexión.');
//             }
...
import { Box, ToggleButtonGroup, ToggleButton, Button, Typography } from "@mui/material";
import ResidentialPropertyForm from "./ResidentialPropertyForm";
import CommercialPropertyForm from "./CommercialPropertyForm";

const PropertyStepper = ({ cities, onPropertyAdded }) => {
    const [propertyType, setPropertyType] = useState("residential");

    const handlePropertyAdded = () => {
        // Lógica para manejar cuando una propiedad es añadida
    };
    ...
    return (
        <Box sx={{ width: "100%" }}>
            ...
            {propertyType === "residential" ? (
                ...
                <CommercialPropertyForm onPropertyAdded={handlePropertyAdded} cities={cities} />
            ) : null}
        </Box>
    );
};
